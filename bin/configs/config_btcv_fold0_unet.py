...
CONFIG = {
    ...
    "training": {
        ...
        "logger": TensorBoardLogger(save_dir="logs/btcv/fold0", name="unet"),
    },
    "test": {
        "checkpoint": {
            "checkpoint_path": "logs/btcv/fold0/unet/version_0/checkpoints/epoch=257-step=99999.ckpt",
        },
        "inferer": datasets.BTCVInferer(
            spacing=(1.5, 1.5, 2.0),
            spatial_size=(96, 96, 96),
            overlap=0.5,
            post="class",
            write_dir="logs/btcv/fold0/unet/version_0/predictions",
        ),
        "save_path": "logs/btcv/fold0/unet/version_0/results.csv",
    },
}
