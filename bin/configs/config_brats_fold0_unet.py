...
CONFIG = {
    ...
    "training": {
        ...
        "logger": TensorBoardLogger(save_dir="logs/brats/fold0", name="unet"),
    },
    "test": {
        "checkpoint": {
        ...
        "inferer": datasets.brats.Inferer(
            ...
            overlap=0.5,
            post="class",
            write_dir="logs/brats/fold0/unet/version_0/predictions",
        ),
        "save_path": "logs/brats/fold0/unet/version_0/results.csv",
    },
}
