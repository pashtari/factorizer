...
#         in_channels,
#         out_channels,
#         conv=(nn.Conv3d, {"kernel_size": 3, "padding": 1, "bias": False}),
#         drop=False,
#         norm=False,
#         act=False,
#         **kwargs,
...
class Upsample3d(nn.Module):
    def __init__(self, c_in, c_out, stride):
        super().__init__()
        self.conv = nn.Conv3d(c_in, c_out, kernel_size=1, bias=False)
        self.upsample = nn.Upsample(
            scale_factor=stride, mode="trilinear", align_corners=True
        )
