...
CONFIG = {
    ...
    "training": {
        ...
        "logger": TensorBoardLogger(
            save_dir="logs/synapse/fold0", name="preunet"
        ),
    },
    "test": {
        "checkpoint": {
            "checkpoint_path": "logs/synapse/fold0/preunet/version_0/checkpoints/epoch=257-step=99999.ckpt",
        },
        "inferer": datasets.synapse.Inferer(
            spacing=(1.5, 1.5, 2.0),
            spatial_size=(96, 96, 96),
            overlap=0.5,
            post="class",
            write_dir="logs/synapse/fold0/preunet/version_0/predictions",
        ),
        "save_path": "logs/synapse/fold0/preunet/version_0/results.csv",
    },
}
