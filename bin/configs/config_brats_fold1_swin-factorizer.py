...
CONFIG = {
    ...
    "training": {
        ...
        "logger": TensorBoardLogger(
            save_dir="logs/brats/fold1", name="swin-factorizer"
        ),
    },
    "test": {
        "checkpoint": {
        ...
        "save_path": "logs/brats/fold1/swin-factorizer/version_0/results.csv",
    },
}
