...
CONFIG = {
    ...
    "test": {
        "checkpoint": {
            "checkpoint_path": "logs/brats/fold0/senmf/version_1/checkpoints/epoch=515-step=99999.ckpt",
        },
        "inferer": datasets.brats.Inferer(
            spatial_size=(128, 128, 128),
            overlap=0.5,
            post="class",
            write_dir="logs/brats/fold0/senmf/version_1/predictions",
        ),
        "save_path": "logs/brats/fold0/senmf/version_1/results.csv",
    },
}
