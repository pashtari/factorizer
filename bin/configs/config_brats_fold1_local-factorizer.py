...
CONFIG = {
    ...
    "training": {
        ...
        "logger": TensorBoardLogger(
            save_dir="logs/brats/fold1", name="local-factorizer"
        ),
    },
    "test": {
        "checkpoint": {
            "checkpoint_path": "logs/brats/fold1/local-factorizer/version_0/checkpoints/epoch=515-step=99999.ckpt",
        },
        "inferer": datasets.BraTSInferer(
            spacing=(1.0, 1.0, 1.0),
            spatial_size=(128, 128, 128),
            overlap=0.5,
            post="class",
            write_dir="logs/brats/fold1/local-factorizer/version_0/predictions",
        ),
        "save_path": "logs/brats/fold1/local-factorizer/version_0/results.csv",
    },
}
