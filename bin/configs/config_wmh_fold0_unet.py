...
CONFIG = {
    ...
    "training": {
        ...
        "logger": TensorBoardLogger(save_dir="logs/wmh/fold0", name="unet"),
    },
    "test": {
        "checkpoint": {
            "checkpoint_path": "logs/wmh/fold0/unet/version_0/checkpoints/epoch=4166-step=99999.ckpt",
        },
        "inferer": datasets.WMHInferer(
            spacing=(1.0, 1.0, 1.0),
            spatial_size=(128, 128, 128),
            overlap=0.5,
            post="class",
            write_dir="logs/wmh/fold0/unet/version_0/predictions",
        ),
        "save_path": "logs/wmh/fold0/unet/version_0/results.csv",
    },
}
