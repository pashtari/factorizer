...
CONFIG = {
    "data": {
        "datamodule": (
            datasets.WMH,
            {
                "data_properties": "/data/leuven/336/vsc33647/data/WMH/dataset_orig.json",
                "spacing": (1.0, 1.0, 1.0),
    ...
    "model": {
        "network": (
            ft.SegmentationFactorizer,
            {
                ...
                "dropout": 0.1,
                "attention": (
                    ft.FastSelfAttention,
                    {"head_dim": 8, "kernel_fn": nn.ReLU(), "dropout": 0.1},
                ),
                "mlp": (ft.MLP, {"ratio": 2, "dropout": 0.1}),
            },
        ),
        "inferer": datasets.WMHInferer(
            spacing=(1.0, 1.0, 1.0),
            spatial_size=(128, 128, 128),
            overlap=0.5,
            post="class",
    ...
    "training": {
        ...
        "logger": TensorBoardLogger(
            save_dir="logs/wmh/fold0", name="global-performer"
        ),
    },
    "test": {
        "checkpoint": {
            "checkpoint_path": "logs/wmh/fold0/global-performer/version_0/checkpoints/epoch=4166-step=99999.ckpt",
        },
        "inferer": datasets.WMHInferer(
            spacing=(1.0, 1.0, 1.0),
            spatial_size=(128, 128, 128),
            overlap=0.5,
            post="class",
            write_dir="logs/wmh/fold0/global-performer/version_0/predictions",
        ),
        "save_path": "logs/wmh/fold0/global-performer/version_0/results.csv",
    },
}
