...
SLURM Submission Example:
  To submit this script as a SLURM job with customized options:
    sbatch --job-name=factorizer_brats23_val_fold0 evaluate.sh --conda_path /path/to/conda --env <env_name> --data_dir /path/to/data --fold 0  --ckpt_name <ckpt_name>
...
python -m monai.bundle run \
    ...
    --config_file "['$BUNDLE_DIR/configs/train.json','$BUNDLE_DIR/configs/evaluate.json']" \
